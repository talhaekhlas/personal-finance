   ...
   ?>
	<div>
		<a href="<?php echo admin_url( "admin.php?page={$page}&action=new" ); ?>">
			<button class="hover:shadow-form rounded-md bg-[#6A64F1] mt-5 py-2 px-8 text-base font-semibold text-white outline-none">
				Add New
			</button>
		</a>
	</div>
	...
	<div class="bg-white shadow-md rounded my-6">
		<table class="text-left w-full border-collapse">
			...
			<tr>
				...
				<th class="<?php echo $th_class; ?>"><?php _e("Source Name"); ?></th>
				<th class="<?php echo $th_class; ?>"><?php _e("Transaction Type"); ?></th>
			...
			<tr class="hover:bg-grey-lighter">
				...
				<td class="<?php echo $td_class; ?>"><?php echo $transaction_type[$value->trn_type]; ?></td>
				<td class="<?php echo $td_class; ?>"><?php echo $value->amount; ?></td>
				<td class="<?php echo $td_class; ?>"><?php echo $value->entry_date; ?></td>
				<td class="<?php echo $td_class; ?>">
