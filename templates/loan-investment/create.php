<?php 
include WPCPF_PLUGIN_DIR . '/templates/loan-investment/error-and-prev-data.php'; 
?>
  ...
  <div class="mx-auto w-full max-w-[550px]">
	<form action="" method="post">
		...
		<div class="mb-5">
			...
			>
			<?php $page == 'loan' ? _e("Loan Transaction Type") : _e("Investment Transaction Type"); ?>
			</label>
			<select 
				name  = "trn_type" 
				id    = "trn_type" 
